...
export type VaultBySymbolQuery = { __typename?: 'Query', vaults: Array<{ __typename?: 'Vault', address: string, name: string, symbol: string, decimals: number, asset: { __typename?: 'Token', address: string, name: string, symbol: string, decimals: number }, rates: Array<{ __typename?: 'InterestRate', perBlock: bigint }> }> };
