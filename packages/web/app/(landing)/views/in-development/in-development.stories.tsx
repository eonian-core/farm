...
export const Default: Story = {
    args: {
        children: (<>
            <heading.H2>Future <br /> of Investments</heading.H2>
            <p>Were in the early stages of developing our innovative protocol, and were excited to invite you to join us on this journey.
