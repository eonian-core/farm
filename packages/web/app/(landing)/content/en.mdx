<Hero>
    ...
    <HeroButtonGroup>
        {process.env.NEXT_PUBLIC_FEATURE_EARN_PAGE === "true" && 
            <HeroButton href="/earn" bold>
                Earn
            </HeroButton>
        }
        {process.env.NEXT_PUBLIC_FEATURE_EARN_PAGE !== "true" &&  // TODO: switch to open dashboard when user joined waitlist
            <HeroButton href="#future-of-investments-is-coming" icon={<IconRobot />} bold>
                Join the Waitlist
            </HeroButton>
        }
