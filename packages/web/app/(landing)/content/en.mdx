<Hero>
    ...
    <HeroButtonGroup>
        <HeroButton href="https://rhetor.ai/EJF0BYU7" color="gradient" icon={<IconExternal />}>
            Join the Waitlist
        </HeroButton>
        <HeroButton href="https://discord.gg/8mcUPPYJmj" bordered color="primary" icon={<IconDiscord />}>
            Join Discord
        </HeroButton>
    </HeroButtonGroup>
</Hero>
