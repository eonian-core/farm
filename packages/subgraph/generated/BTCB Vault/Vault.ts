...
export class Vault__borrowersDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Vault extends ethereum.SmartContract {
  ...
  borrowersData(param0: Address): Vault__borrowersDataResult {
    let result = super.call(
      "borrowersData",
    ...
    return new Vault__borrowersDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_borrowersData(
    param0: Address,
  ): ethereum.CallResult<Vault__borrowersDataResult> {
    let result = super.tryCall(
      "borrowersData",
      "borrowersData(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)],
    ...
    return ethereum.CallResult.fromValue(
      new Vault__borrowersDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  try_interestRatePerBlock(): ethereum.CallResult<Vault__interestRatePerBlockResult> {
    let result = super.tryCall(
      "interestRatePerBlock",
      "interestRatePerBlock():(uint256,uint256)",
      [],
