...
contract SafeInitializable is Initializable {
     ...
     *  but later, in version 4.3.2, OpenZepplin implemented `onlyProxy` modifier for UUPS upgradable contracts, which fixed this vulnarability.
     *  Still `_disableInitializers()` is best practice which prevent unintended access to implementation contracts which can be used for malicious purposes.
     *  
     *  More info: https://forum.openzeppelin.com/t/how-to-test-upgradeability-for-proxies/33436/7 and https://forum.openzeppelin.com/t/uupsupgradeable-vulnerability-post-mortem/15680
     * 
     * To prevent code dublication of cconstructor this contract can be used. On the other hand, it can be used as a marker for contracts which are safe from this vulnerability.
