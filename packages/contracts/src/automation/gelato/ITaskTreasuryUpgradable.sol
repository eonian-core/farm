...
/// Based on https://github.com/gelatodigital/automate-unit-testing/blob/main/contracts/gelato/ITaskTreasuryUpgradable.sol
interface ITaskTreasuryUpgradable {
  /// @notice Events ///

  event FundsDeposited(
    address indexed sender, address indexed token, uint256 indexed amount
  );
  ...
  function depositFunds(address receiver, address token, uint256 amount)
    external
    payable;
